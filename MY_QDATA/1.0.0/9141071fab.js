var _E8_BF_94_E5_9B_9E_E5_80_BC;
...
Widget.prototype.set = function (table_id,table_key,name,value,) {
    ...
    .then((response) => {
      _E8_BF_94_E5_9B_9E_E5_80_BC = (response.data);
  ...
  this.widgetLog(_E8_BF_94_E5_9B_9E_E5_80_BC);
...
Widget.prototype.read = function (table_id,table_key,name,wrong_return,) {
    ...
    .catch((error) => {
      _E8_BF_94_E5_9B_9E_E5_80_BC = wrong_return;

    });
  while (!((JSON.parse(_E8_BF_94_E5_9B_9E_E5_80_BC)['code']) == 200 || (JSON.parse(_E8_BF_94_E5_9B_9E_E5_80_BC)['code']) == 403)) {
    this.widgetLog();
  }
  return _E8_BF_94_E5_9B_9E_E5_80_BC;
}
types['methods'].push({
    key: 'del',
    label: '删除',
...
Widget.prototype.del = function (table_id,table_key,name,) {
      axios.get((['https://qdata.space/api.php?','table_id=' + String(table_id),'&mode=' + 'del','&name=' + String(name),'&key=' + String(CryptoJS.SHA256(([new Date().getMinutes(),table_id,table_key].join(''))).toString())].join('')))
    .then((response) => {
      _E8_BF_94_E5_9B_9E_E5_80_BC = (response.data);

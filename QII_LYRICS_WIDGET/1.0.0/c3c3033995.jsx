...
let types = {
    ...
    properties: [
        ...
        { key: 'lyricColor', label: '歌词颜色', valueType: 'color', defaultValue: '#FFFFFF' },
        { key: 'lyricActiveColor', label: '当前歌词颜色', valueType: 'color', defaultValue: '#FFFFFF' },
        { key: 'lyricTColor', label: '歌词翻译颜色', valueType: 'color', defaultValue: '#FFFFFFB0' },
        { key: 'lyricTActiveColor', label: '当前歌词翻译颜色', valueType: 'color', defaultValue: '#FFFFFFB0' },
        { key: 'lyricOpacity', label: '歌词透明度', valueType: 'number', defaultValue: 50, unit: '%' },
        { key: 'lyricActiveOpacity', label: '当前歌词透明度', valueType: 'number', defaultValue: 100, unit: '%' },
        { key: 'lyricSize', label: '歌词文本大小', valueType: 'number', defaultValue: 22, unit: '像素' },
        { key: 'lyricTSize', label: '歌词翻译文本大小', valueType: 'number', defaultValue: 20, unit: '像素' },
        ...
        { key: 'lyricBold', label: '歌词加粗', valueType: 'boolean', defaultValue: false },
...
class Widget extends VisibleWidget {
    ...
    renderLyrics() {
        ...
        try {
            ...
            Object.values(lyricsMap).forEach(item => {
                resultList.push(
                    <div className="lyric-item" onClick={() => this.emit('onClickLyric', convertToSeconds(item.time)) } >
    ...
    render() {
        return (
            <div className={`lyrics-container Qii_${this.__widgetId} ${this.lyricsString != '' ? 'show' : ''}`}>
                ...
                <style>
                    ...
                    .Qii_${this.__widgetId} .lyric-list {
                        padding: 100px ${this.listPadding}px 500px ${this.listPadding}px;
                    }

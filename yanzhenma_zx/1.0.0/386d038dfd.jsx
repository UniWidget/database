//制作：ZX
//验证码生成代码来源:https://blog.csdn.net/qq_42438879/article/details/114851590
...
class Widget extends VisibleWidget {
    ...
    yanzhen(yanzhenma) {
        verifyCode.validate(yanzhenma) ? this.emit('isok') : this.emit('isnot');
    }
    chushihua() {
    ...
    render() {
        return (
            <>
                <div id={'zx-view' + this.id} style={{ width: '100%', height: '100%' }}></div>
            </>
        )
    }
}

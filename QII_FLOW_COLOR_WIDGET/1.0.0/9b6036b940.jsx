...
let types = {
    ...
    properties: [
        ...
        { key: 'blur', label: '模糊效果', unit: '强度', valueType: 'number', defaultValue: 60 },
    ],
    events: [],
    methods: [
        {

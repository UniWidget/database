...
var window = this.window;//获取权限
const types = {
    isInvisibleWidget: true,
    type: "SHARE_HAOZI_WIDGET",
    icon: "https://ocean.codemao.cn/appcraft/resource/icon/社交/分享.svg",
    title: "分享第三方",
    version: "1.2.0",//控件商城优化版本
...
Widget.prototype.QP = function () {
      return 'https://ocean.codemao.cn/appcraft/resource/icon/社交/QQ.svg';
}
types['methods'].push({
    key: 'ZP',
    label: 'QQ空间图标',

...
class Widget extends VisibleWidget {
  ...
  this.yuan_jiao=props.yuan_jiao;

  }
  render() {
    return(
      React.createElement("iframe", {  borderColor: '#000000',
      backgroundColor: '#000000',
      width: (this.width),
      height: (this.height),
      borderRadios: (this.yuan_jiao),
      src: (this.https),
    }, null)
  );
...
Widget.prototype.set_yuan = function (set_yuan_set,) {
      this.setProps({ 'yuan_jiao': set_yuan_set });

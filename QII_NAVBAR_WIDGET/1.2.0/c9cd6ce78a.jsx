...
let types = {
    ...
    properties: [
        ...
        { key: 'bgColor', label: '背景颜色', valueType: 'color', defaultValue: '#FFFFFF' },
        { key: 'bgBlur', label: '背景模糊', unit: '像素', valueType: 'number', defaultValue: 0 },
        { key: 'navTitle', label: '标题文本', valueType: 'string', defaultValue: '标题文本' },
        { key: 'titleColor', label: '标题文本颜色', valueType: 'color', defaultValue: '#000000' },
        { key: 'titleSize', label: '标题文本大小', unit: '像素', valueType: 'number', defaultValue: 16 },
        { key: 'titleBold', label: '标题加粗', valueType: 'boolean', defaultValue: true },
        { key: 'navText', label: '标题底部文本', valueType: 'string', defaultValue: '' },
        { key: 'navTextColor', label: '标题底部文本颜色', valueType: 'color', defaultValue: '#A6A6A6' },
        { key: 'navTextSize', label: '标题底部文本大小', unit: '像素', valueType: 'number', defaultValue: 12 },
        { key: 'showBack', label: '显示返回按钮', valueType: 'boolean', defaultValue: true },
        { key: 'leftText', label: '左侧文本', valueType: 'string', defaultValue: '返回' },
        { key: 'leftTextColor', label: '左侧文本颜色', valueType: 'color', defaultValue: '#1E90FF' },
        { key: 'leftTextSize', label: '左侧文本大小', unit: '像素', valueType: 'number', defaultValue: 14 },
        { key: 'iconList', label: '右侧图标列表', valueType: 'string', editorType: 'TextArea', 
            defaultValue: `
...
M20 18a1 1 0 0 1 .117 1.993L20 20H4a1 1 0 0 1-.117-1.993L4 18zm0-7a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2zm0-7a1 1 0 1 1 0 2H4a1 1 0 0 1 0-2z
        ` },
        { key: 'iconColor', label: '右侧图标颜色', valueType: 'color', defaultValue: '#202020' },
        { key: 'iconSize', label: '右侧图标大小', unit: '像素', valueType: 'number', defaultValue: 20 },
        { key: 'borderSize', label: '分割线粗细', unit: '像素', valueType: 'number', defaultValue: 0 },
        { key: 'borderColor', label: '分割线颜色', valueType: 'color', defaultValue: '#00000010' },
    ],
    events: [
...
class Widget extends VisibleWidget {
    ...
    render() { return (
        <div className="Qii_Navbar_Widget" style={{ 
            ...
            transform: `rotate(${this.rotation}deg)`, // 新增旋转样式
        }}>
            ...
            <style>
                {` 
                    .Qii_Navbar_Widget {
                        ...
                        transform-origin: center center; /* 新增旋转中心 */
                        transition: transform 0.2s;     /* 新增过渡动画 */
                    }
                    .Qii_Navbar_Widget p {
                        margin: 0;
                    }

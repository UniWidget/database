...
const types = {
  type: "LYRIC_DISPLAY_SUPER_SUPER",
  ...
  properties: [
    ...
    },
    {
      ...
      valueType: "string",
      editorType: "TextArea",
      defaultValue: "/*这里是字体阴影*/\ntext-shadow: -0.8px -0.8px 0.80px rgba(255, 255, 255, 0.5), 0.8px -0.8px 0.80px rgba(255, 255, 255, 0.5), -0.8px 0.8px 0.80px rgba(255, 255, 255, 0.5), 0.8px 0.8px 0.80px rgba(255, 255, 255, 0.5);/*这里是连词打断*/\nword-break: break-all;\n/*这里是字体加粗*/\nfont-weight:bold;\n/*可以在这里自定义已引入字体*/\nfont-family: Monospaced Number,Chinese Quote,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,sans-serif;",
      readonly: false,
    },
    {
      key: "moreUnBlur",

...
const types = {
    ...
    isGlobalWidget: true,
    author:"borderRadius原，大羽同学二改",
    modifiedTime:"2023/10/12 10:02:50",
    properties:[],
    methods: [{
        key:"opener",
        label:"打开文件",
...
class Widget extends InvisibleWidget {
 ...
 async URL2Text(link){
    try{
        const a = await window[fuck_bcm_ban_word](link);
        return await a.text()
    }catch(e){
  ...
  async ToBuffer(a,b){
    var eme = [];
    try{
         const z = await window[fuck_bcm_ban_word](a);
